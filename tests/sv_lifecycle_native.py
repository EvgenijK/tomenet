#!/usr/bin/env python3
"""Native window events, accepted macro input and session replacement."""
import argparse
import os
...
a = p.parse_args()
with tempfile.TemporaryDirectory(prefix='sv-lifecycle-check-') as directory:
    work = Path(directory)
    def native(path):

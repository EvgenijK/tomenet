#!/usr/bin/env python3
"""Production message decode, ordered events and native frame checks."""
import argparse
import os
...
with tempfile.TemporaryDirectory(prefix='sv-message-check-') as directory:
    work = Path(directory)
    def native(path):

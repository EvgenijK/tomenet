...
Завершить необходимые production части [SV-B-003](SV-B-003-profile.md), [SV-B-004](SV-B-004-save.md), [SV-B-039](SV-B-039-map-effects.md).
...
| `capability.options.view-light-extra` | Apply view_light_extra: Lamp light affects more floor/wall types. Preserve literal baseline default/build row T; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:230](../../../src/client/c-tables.c#L230)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:229](../../../src/client/c-tables.c#L229)<br>[cave.c:3322](../../../src/server/cave.c#L3322)<br>[cave.c:3327](../../../src/server/cave.c#L3327) |
| `capability.options.view-perma-grids` | Apply view_perma_grids: Map remembers all perma-lit grids. Preserve literal baseline default/build row T; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:376](../../../src/client/c-tables.c#L376)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:375](../../../src/client/c-tables.c#L375)<br>[dungeon.c:1988](../../../src/server/dungeon.c#L1988)<br>[dungeon.c:2089](../../../src/server/dungeon.c#L2089) |
| `capability.options.view-torch-grids` | Apply view_torch_grids: Map remembers all torch-lit grids. Preserve literal baseline default/build row F; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:378](../../../src/client/c-tables.c#L378)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:377](../../../src/client/c-tables.c#L377)<br>[cave.c:4489](../../../src/server/cave.c#L4489)<br>[cave.c:8546](../../../src/server/cave.c#L8546) |
| `capability.options.view-reduce-light` | Apply view_reduce_light: Reduce light radius when running. Preserve literal baseline default/build row F; E=F; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:382](../../../src/client/c-tables.c#L382)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:381](../../../src/client/c-tables.c#L381)<br>[xtra1.c:2054](../../../src/server/xtra1.c#L2054) |
...
|---|---|
| `capability.options.view-shade-floor` | Apply view_shade_floor: Use special colors to shade floor grids — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
| `capability.options.view-light-extra` | Apply view_light_extra: Lamp light affects more floor/wall types — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
| `capability.options.view-perma-grids` | Apply view_perma_grids: Map remembers all perma-lit grids — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
| `capability.options.view-torch-grids` | Apply view_torch_grids: Map remembers all torch-lit grids — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
| `capability.options.view-reduce-light` | Apply view_reduce_light: Reduce light radius when running — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
| `capability.options.view-reduce-view` | Apply view_reduce_view: Reduce view radius in town — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
...
| `capability.options.no-light-fainting` | Apply no_light_fainting: Disable shading effect for fainting light source — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.world.read-map |
...
|---|---|
| `capability.options.view-shade-floor` | `capability.world.read-map` |
| `capability.options.view-light-extra` | `capability.world.read-map` |
| `capability.options.view-perma-grids` | `capability.world.read-map` |
| `capability.options.view-torch-grids` | `capability.world.read-map` |
| `capability.options.view-reduce-light` | `capability.world.read-map` |
| `capability.options.view-reduce-view` | `capability.world.read-map` |
| `capability.options.permawalls-shade` | `capability.world.read-map` |
| `capability.options.no-light-fainting` | `capability.world.read-map` |
...
- `capability.options.view-shade-floor`, `capability.options.view-light-extra`, `capability.options.view-perma-grids`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — T; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..
- `capability.options.view-torch-grids`, `capability.options.permawalls-shade`, `capability.options.no-light-fainting`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — F; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..
- `capability.options.view-reduce-light`, `capability.options.view-reduce-view`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — F; E=F; —; retain consumer feature/version/runtime gates and Send_options projection..

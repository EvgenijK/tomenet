...
Завершить необходимые production части [SV-B-002](SV-B-002-contact.md), [SV-B-003](SV-B-003-profile.md), [SV-B-004](SV-B-004-save.md), [SV-B-043](SV-B-043-screenshots-platform.md), [SV-B-044](SV-B-044-message-clones.md).
...
| `capability.options.disable-flush` | Apply disable_flush: Disable delays from flush signals. Preserve literal baseline default/build row F; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:353](../../../src/client/c-tables.c#L353)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:352](../../../src/client/c-tables.c#L352)<br>[nclient.c:4039](../../../src/client/nclient.c#L4039) |
| `capability.options.screenshot-format` | Apply screenshot_format: Screenshots are timestamped instead of numbered. Preserve literal baseline default/build row T; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:500](../../../src/client/c-tables.c#L500)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:499](../../../src/client/c-tables.c#L499)<br>[c-files.c:2645](../../../src/client/c-files.c#L2645)<br>[c-init.c:3685](../../../src/client/c-init.c#L3685) |
...
|---|---|
| `capability.options.thin-down-flush` | Apply thin_down_flush: Thin down screen flush signals to avoid freezing — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.session.enter-game capability.session.disconnect |
| `capability.options.disable-flush` | Apply disable_flush: Disable delays from flush signals — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.session.enter-game capability.session.disconnect |
| `capability.options.screenshot-format` | Apply screenshot_format: Screenshots are timestamped instead of numbered — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.screenshots.capture |
...
| `capability.options.clone-to-stdout` | Apply clone_to_stdout: Clone client chat and messages to stdout — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.messages.read-live |
| `capability.options.clone-to-file` | Apply clone_to_file: Clone client chat and messages to 'stdout.txt' — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.messages.read-live |
...
|---|---|
| `capability.options.thin-down-flush` | `capability.session.enter-game`, `capability.session.disconnect` |
| `capability.options.disable-flush` | `capability.session.enter-game`, `capability.session.disconnect` |
| `capability.options.screenshot-format` | `capability.screenshots.capture` |
| `capability.options.quiet-os` | `capability.messages.read-live`, `capability.audio.play-event` |
| `capability.options.clone-to-stdout` | `capability.messages.read-live` |
| `capability.options.clone-to-file` | `capability.messages.read-live` |
...
- `capability.options.thin-down-flush`, `capability.options.screenshot-format`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — T; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..
- `capability.options.disable-flush`, `capability.options.quiet-os`, `capability.options.clone-to-stdout`, `capability.options.clone-to-file`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — F; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..

...
| `capability.options.short-item-names` | Apply short_item_names: Don't display known 'flavours' in item names. Preserve literal baseline default/build row F; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:278](../../../src/client/c-tables.c#L278)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:277](../../../src/client/c-tables.c#L277)<br>[object1.c:2438](../../../src/server/object1.c#L2438)<br>[object1.c:2217](../../../src/server/object1.c#L2217)<br>[object1.c:2243](../../../src/server/object1.c#L2243) |
| `capability.options.auto-untag` | Apply auto_untag: Remove unique monster inscription on pick-up. Preserve literal baseline default/build row F; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:321](../../../src/client/c-tables.c#L321)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:320](../../../src/client/c-tables.c#L320)<br>[cmd1.c:2682](../../../src/server/cmd1.c#L2682) |
| `capability.options.clear-inscr` | Apply clear_inscr: Clear @-inscriptions on taking item ownership. Preserve literal baseline default/build row F; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:323](../../../src/client/c-tables.c#L323)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:322](../../../src/client/c-tables.c#L322)<br>[cmd1.c:2661](../../../src/server/cmd1.c#L2661)<br>[xtra2.c:15897](../../../src/server/xtra2.c#L15897) |
...
|---|---|
| `capability.options.show-weights` | Apply show_weights: Show weights in object listings — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.read-inventory capability.items.read-equipment |
| `capability.options.short-item-names` | Apply short_item_names: Don't display known 'flavours' in item names — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.read-inventory capability.items.read-equipment |
| `capability.options.auto-untag` | Apply auto_untag: Remove unique monster inscription on pick-up — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.pickup-accept |
| `capability.options.clear-inscr` | Apply clear_inscr: Clear @-inscriptions on taking item ownership — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.pickup-accept |
| `capability.options.auto-inscr-server` | Apply auto_inscr_server: Also use predefined server-side auto-inscriptions — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.pickup-accept capability.items.autoinscribe-on-update |
| `capability.options.stack-force-notes` | Apply stack_force_notes: Merge inscriptions when stacking — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.pickup-accept capability.items.autoinscribe-on-update |
| `capability.options.stack-force-costs` | Apply stack_force_costs: Merge discounts when stacking — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.items.pickup-accept capability.items.autoinscribe-on-update |
...
|---|---|
| `capability.options.show-weights` | `capability.items.read-inventory`, `capability.items.read-equipment` |
| `capability.options.short-item-names` | `capability.items.read-inventory`, `capability.items.read-equipment` |
| `capability.options.auto-untag` | `capability.items.pickup-accept` |
| `capability.options.clear-inscr` | `capability.items.pickup-accept` |
| `capability.options.auto-inscr-server` | `capability.items.pickup-accept`, `capability.items.autoinscribe-on-update` |
| `capability.options.stack-force-notes` | `capability.items.pickup-accept`, `capability.items.autoinscribe-on-update` |
| `capability.options.stack-force-costs` | `capability.items.pickup-accept`, `capability.items.autoinscribe-on-update` |
...
- `capability.options.show-weights`, `capability.options.stack-force-notes`, `capability.options.stack-force-costs`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — T; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..
- `capability.options.short-item-names`, `capability.options.auto-untag`, `capability.options.clear-inscr`, `capability.options.auto-inscr-server`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — F; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..

...
| `capability.options.ovl-sfx-mon-spell` | Apply ovl_sfx_mon_spell: Allow ovl. monster spell/breath sfx of same type. Preserve literal baseline default/build row T; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:420](../../../src/client/c-tables.c#L420)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:419](../../../src/client/c-tables.c#L419)<br>[snd-sdl3.c:2115](../../../src/client/snd-sdl3.c#L2115)<br>[snd-sdl.c:1913](../../../src/client/snd-sdl.c#L1913) |
| `capability.options.ovl-sfx-mon-misc` | Apply ovl_sfx_mon_misc: Allow overlapping misc monster sfx of same type. Preserve literal baseline default/build row T; E=T; —, boolean meaning and option slot; own global/character OPT, permitted shared macro effects, explicit Save. Final semantic display-option overlay in settings-policy.md overrides draft L/U no-op proposals. | [c-tables.c:422](../../../src/client/c-tables.c#L422)<br>[c-files.c:1047](../../../src/client/c-files.c#L1047)<br>[c-tables.c:421](../../../src/client/c-tables.c#L421)<br>[snd-sdl3.c:2117](../../../src/client/snd-sdl3.c#L2117)<br>[snd-sdl.c:1915](../../../src/client/snd-sdl.c#L1915) |
...
|---|---|
| `capability.options.ovl-sfx-mon-attack` | Apply ovl_sfx_mon_attack: Allow overlapping monster attack sfx of same type — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.audio.play-event capability.audio.music capability.audio.weather |
| `capability.options.ovl-sfx-mon-spell` | Apply ovl_sfx_mon_spell: Allow ovl. monster spell/breath sfx of same type — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.audio.play-event capability.audio.music capability.audio.weather |
| `capability.options.ovl-sfx-mon-misc` | Apply ovl_sfx_mon_misc: Allow overlapping misc monster sfx of same type — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.audio.play-event capability.audio.music capability.audio.weather |
| `capability.options.no-monsterattack-sfx` | Apply no_monsterattack_sfx: Don't play basic monster attack sound fx — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.audio.play-event capability.audio.music capability.audio.weather |
| `capability.options.positional-audio` | Apply positional_audio: Play '3d' positional sound fx, via normal stereo — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.audio.play-event capability.audio.music capability.audio.weather |
| `capability.options.no-house-sfx` | Apply no_house_sfx: Don't play ambient/weather sound in buildings — обе BOOL-ветви через production SV и указанный реальный consumer, не standalone parser. OPT default/slot, own global/character Save→reload, Preview→Cancel, macro directive override; применимые compile/version guards. Повторить caller-specific проверки при C/D/E; поздний caller остаётся pending до его этапа. Для server-owned значения: Send_options→sync_options→consumer→наблюдаемый ответ; сохранить инверсию slot и актуальную server-version ветвь. Для local-only значения не изобретать server effect. Consumer fixtures: capability.audio.play-event capability.audio.music capability.audio.weather |
...
|---|---|
| `capability.options.ovl-sfx-mon-attack` | `capability.audio.play-event`, `capability.audio.music`, `capability.audio.weather` |
| `capability.options.ovl-sfx-mon-spell` | `capability.audio.play-event`, `capability.audio.music`, `capability.audio.weather` |
| `capability.options.ovl-sfx-mon-misc` | `capability.audio.play-event`, `capability.audio.music`, `capability.audio.weather` |
| `capability.options.no-monsterattack-sfx` | `capability.audio.play-event`, `capability.audio.music`, `capability.audio.weather` |
| `capability.options.positional-audio` | `capability.audio.play-event`, `capability.audio.music`, `capability.audio.weather` |
| `capability.options.no-house-sfx` | `capability.audio.play-event`, `capability.audio.music`, `capability.audio.weather` |
...
- `capability.options.ovl-sfx-mon-attack`, `capability.options.ovl-sfx-mon-spell`, `capability.options.ovl-sfx-mon-misc`, `capability.options.positional-audio`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — T; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..
- `capability.options.no-monsterattack-sfx`, `capability.options.no-house-sfx`: versions — Retain all version branches of the cited owner; local operations require no server. Protocol-dependent consumers keep their existing gates and slot/byte identities.; builds — F; E=T; —; retain consumer feature/version/runtime gates and Send_options projection..
